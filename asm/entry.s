...
glabel func_80000400
    /* 1000 80000400 3C088004 */  lui        $t0, %hi(D_80045670)
    /* 1004 80000404 3C090005 */  lui        $t1, (0x55250 >> 16)
    /* 1008 80000408 25085670 */  addiu      $t0, $t0, %lo(D_80045670)
    /* 100C 8000040C 35295250 */  ori        $t1, $t1, (0x55250 & 0xFFFF)
  .L80000410:
    ...
    /* 1024 80000424 3C0A8000 */  lui        $t2, %hi(game_main)
    /* 1028 80000428 3C1D8004 */  lui        $sp, %hi(D_80045870)
    /* 102C 8000042C 254A0870 */  addiu      $t2, $t2, %lo(game_main)
    /* 1030 80000430 01400008 */  jr         $t2
    /* 1034 80000434 27BD5870 */   addiu     $sp, $sp, %lo(D_80045870)
