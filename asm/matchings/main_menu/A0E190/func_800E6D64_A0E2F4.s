...
glabel func_800E6D64_A0E2F4
    ...
    /* A0E300 800E6D70 3C188034 */  lui        $t8, %hi(D_80344388_55BD18)
    /* A0E304 800E6D74 AFBF0044 */  sw         $ra, 0x44($sp)
    /* A0E308 800E6D78 3C078000 */  lui        $a3, (0x80000000 >> 16)
    /* A0E30C 800E6D7C 27184388 */  addiu      $t8, $t8, %lo(D_80344388_55BD18)
    ...
    /* A0E378 800E6DE8 3C058034 */  lui        $a1, %hi(D_80343B28)
    /* A0E37C 800E6DEC 00409025 */  or         $s2, $v0, $zero
    /* A0E380 800E6DF0 24A53B28 */  addiu      $a1, $a1, %lo(D_80343B28)
    ...
    /* A0E39C 800E6E0C 3C058034 */  lui        $a1, %hi(bulbasaur_model + 0x158)
    /* A0E3A0 800E6E10 24A54618 */  addiu      $a1, $a1, %lo(bulbasaur_model + 0x158)
    ...
    /* A0E3C4 800E6E34 3C058034 */  lui        $a1, %hi(D_80343C08)
    /* A0E3C8 800E6E38 24A53C08 */  addiu      $a1, $a1, %lo(D_80343C08)
    ...
    /* A0E3FC 800E6E6C 3C188034 */  lui        $t8, %hi(D_80344388_55BD18)
    /* A0E400 800E6E70 3C078000 */  lui        $a3, (0x80000000 >> 16)
    /* A0E404 800E6E74 27184388 */  addiu      $t8, $t8, %lo(D_80344388_55BD18)
    ...
    /* A0E458 800E6EC8 3C058034 */  lui        $a1, %hi(D_80343B28)
    /* A0E45C 800E6ECC 00409025 */  or         $s2, $v0, $zero
    /* A0E460 800E6ED0 24A53B28 */  addiu      $a1, $a1, %lo(D_80343B28)
    ...
    /* A0E484 800E6EF4 3C058034 */  lui        $a1, %hi(bulbasaur_model + 0x18)
    /* A0E488 800E6EF8 24A544D8 */  addiu      $a1, $a1, %lo(bulbasaur_model + 0x18)
    ...
    /* A0E4AC 800E6F1C 3C058034 */  lui        $a1, %hi(D_80343C08)
    /* A0E4B0 800E6F20 24A53C08 */  addiu      $a1, $a1, %lo(D_80343C08)
