...
glabel func_800E5FDC_A0D56C
    ...
    /* A0D574 800E5FE4 3C198031 */  lui        $t9, %hi(D_803128E0)
    /* A0D578 800E5FE8 AFBF0044 */  sw         $ra, 0x44($sp)
    /* A0D57C 800E5FEC 3C078000 */  lui        $a3, (0x80000000 >> 16)
    /* A0D580 800E5FF0 273928E0 */  addiu      $t9, $t9, %lo(D_803128E0)
    ...
    /* A0D5F0 800E6060 3C058031 */  lui        $a1, %hi(D_803128E0)
    /* A0D5F4 800E6064 00408825 */  or         $s1, $v0, $zero
    /* A0D5F8 800E6068 24A528E0 */  addiu      $a1, $a1, %lo(D_803128E0)
    ...
    /* A0D61C 800E608C 3C058031 */  lui        $a1, %hi(D_803128E0)
    /* A0D620 800E6090 24A528E0 */  addiu      $a1, $a1, %lo(D_803128E0)
    ...
    /* A0D644 800E60B4 3C058031 */  lui        $a1, %hi(D_803128E0)
    /* A0D648 800E60B8 24A528E0 */  addiu      $a1, $a1, %lo(D_803128E0)
    ...
    /* A0D66C 800E60DC 3C058031 */  lui        $a1, %hi(D_80312238)
    /* A0D670 800E60E0 24A52238 */  addiu      $a1, $a1, %lo(D_80312238)
    ...
    /* A0D694 800E6104 3C058031 */  lui        $a1, %hi(D_80312238)
    /* A0D698 800E6108 24A52238 */  addiu      $a1, $a1, %lo(D_80312238)
    ...
    /* A0D6BC 800E612C 3C058034 */  lui        $a1, %hi(D_8033ED70)
    /* A0D6C0 800E6130 24A5ED70 */  addiu      $a1, $a1, %lo(D_8033ED70)
    ...
    /* A0D6E4 800E6154 3C058034 */  lui        $a1, %hi(D_8033ED70)
    /* A0D6E8 800E6158 24A5ED70 */  addiu      $a1, $a1, %lo(D_8033ED70)
    ...
    /* A0D70C 800E617C 3C058034 */  lui        $a1, %hi(D_8033ED70)
    /* A0D710 800E6180 24A5ED70 */  addiu      $a1, $a1, %lo(D_8033ED70)
