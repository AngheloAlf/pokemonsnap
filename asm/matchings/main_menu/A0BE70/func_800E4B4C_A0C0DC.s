...
glabel func_800E4B4C_A0C0DC
    ...
    /* A0C130 800E4BA0 3C05803B */  lui        $a1, %hi(D_803A80D0_main_menu_vpk0)
    /* A0C134 800E4BA4 ADE30054 */  sw         $v1, 0x54($t7)
    /* A0C138 800E4BA8 4406B000 */  mfc1       $a2, $f22
    /* A0C13C 800E4BAC 24A580D0 */  addiu      $a1, $a1, %lo(D_803A80D0_main_menu_vpk0)
    ...
    /* A0C168 800E4BD8 3C058038 */  lui        $a1, %hi(D_80381D60_main_menu_vpk0)
    /* A0C16C 800E4BDC 4406B000 */  mfc1       $a2, $f22
    /* A0C170 800E4BE0 24A51D60 */  addiu      $a1, $a1, %lo(D_80381D60_main_menu_vpk0)
    ...
    /* A0C190 800E4C00 3C058038 */  lui        $a1, %hi(D_80385700_main_menu_vpk0)
    /* A0C194 800E4C04 4406B000 */  mfc1       $a2, $f22
    /* A0C198 800E4C08 24A55700 */  addiu      $a1, $a1, %lo(D_80385700_main_menu_vpk0)
    ...
    /* A0C1B8 800E4C28 3C05803A */  lui        $a1, %hi(D_803A1BE0_main_menu_vpk0)
    /* A0C1BC 800E4C2C 4406B000 */  mfc1       $a2, $f22
    /* A0C1C0 800E4C30 24A51BE0 */  addiu      $a1, $a1, %lo(D_803A1BE0_main_menu_vpk0)
    ...
    /* A0C1E0 800E4C50 3C05803A */  lui        $a1, %hi(D_803A7F90_main_menu_vpk0)
    /* A0C1E4 800E4C54 4406B000 */  mfc1       $a2, $f22
    /* A0C1E8 800E4C58 24A57F90 */  addiu      $a1, $a1, %lo(D_803A7F90_main_menu_vpk0)
    ...
    /* A0C208 800E4C78 3C058036 */  lui        $a1, %hi(D_80359B30_main_menu_vpk0)
    /* A0C20C 800E4C7C 4406B000 */  mfc1       $a2, $f22
    /* A0C210 800E4C80 24A59B30 */  addiu      $a1, $a1, %lo(D_80359B30_main_menu_vpk0)
    ...
    /* A0C230 800E4CA0 3C058036 */  lui        $a1, %hi(D_80359CD0_main_menu_vpk0)
    /* A0C234 800E4CA4 4406B000 */  mfc1       $a2, $f22
    /* A0C238 800E4CA8 24A59CD0 */  addiu      $a1, $a1, %lo(D_80359CD0_main_menu_vpk0)
    ...
    /* A0C258 800E4CC8 3C058039 */  lui        $a1, %hi(D_8038F9C0_main_menu_vpk0)
    /* A0C25C 800E4CCC 4406B000 */  mfc1       $a2, $f22
    /* A0C260 800E4CD0 24A5F9C0 */  addiu      $a1, $a1, %lo(D_8038F9C0_main_menu_vpk0)
    ...
    /* A0C280 800E4CF0 3C058039 */  lui        $a1, %hi(D_80393AE0_main_menu_vpk0)
    /* A0C284 800E4CF4 4406B000 */  mfc1       $a2, $f22
    /* A0C288 800E4CF8 24A53AE0 */  addiu      $a1, $a1, %lo(D_80393AE0_main_menu_vpk0)
    ...
    /* A0C2A8 800E4D18 3C058039 */  lui        $a1, %hi(D_80393DC0_main_menu_vpk0)
    /* A0C2AC 800E4D1C 4406B000 */  mfc1       $a2, $f22
    /* A0C2B0 800E4D20 24A53DC0 */  addiu      $a1, $a1, %lo(D_80393DC0_main_menu_vpk0)
