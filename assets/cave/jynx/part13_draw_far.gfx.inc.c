...
Gfx jynx_part13_draw_far[] = {
    ...
    gsDPPipeSync(),
    gsSPVertex(&jynx_vtx[449], 8, 0),
    gsSP2Triangles(7, 6, 5, 0, 7, 5, 4, 0),
    gsSP2Triangles(4, 6, 3, 0, 5, 6, 4, 0),
    gsSP2Triangles(7, 2, 6, 0, 4, 2, 7, 0),
    gsSP2Triangles(6, 2, 1, 0, 1, 3, 6, 0),
    gsSP2Triangles(1, 2, 4, 0, 3, 0, 4, 0),
    gsSP2Triangles(4, 0, 1, 0, 0, 3, 1, 0),
    gsSPEndDisplayList(),
};
