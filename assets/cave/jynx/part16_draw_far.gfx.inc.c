...
Gfx jynx_part16_draw_far[] = {
    ...
    gsDPPipeSync(),
    gsSPVertex(&jynx_vtx[477], 8, 0),
    gsSP2Triangles(7, 6, 5, 0, 4, 6, 7, 0),
    gsSP2Triangles(6, 4, 3, 0, 7, 5, 3, 0),
    gsSP2Triangles(7, 2, 4, 0, 3, 4, 1, 0),
    gsSP2Triangles(3, 2, 7, 0, 1, 4, 0, 0),
    gsSP2Triangles(4, 2, 0, 0, 3, 1, 0, 0),
    gsSP2Triangles(0, 2, 3, 0, 3, 5, 6, 0),
    gsSPEndDisplayList(),
};
