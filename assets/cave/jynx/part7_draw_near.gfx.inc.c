...
Gfx jynx_part7_draw_near[] = {
    ...
    gsSPModifyVertex(0, G_MWO_POINT_ST, 0x030F020F),
    gsSPModifyVertex(1, G_MWO_POINT_ST, 0x000F020F),
    gsSPModifyVertex(2, G_MWO_POINT_ST, 0x010F020F),
    gsSPModifyVertex(3, G_MWO_POINT_ST, 0x03EF020F),
    gsSPModifyVertex(4, G_MWO_POINT_ST, 0x020F020F),
    gsSPVertex(&jynx_vtx[180], 2, 5),
    gsSP1Triangle(6, 0, 3, 0),
    gsSPModifyVertex(3, G_MWO_POINT_ST, 0x030F020F),
    gsSP2Triangles(4, 6, 3, 0, 2, 1, 5, 0),
