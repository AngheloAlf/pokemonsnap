...
Gfx jynx_part6_draw_near[] = {
    ...
    gsSPModifyVertex(0, G_MWO_POINT_ST, 0x01A403FB),
    gsSPModifyVertex(1, G_MWO_POINT_ST, 0x0000038F),
    gsSPModifyVertex(2, G_MWO_POINT_ST, 0x03EF020F),
    gsSPVertex(&jynx_vtx[178], 2, 3),
