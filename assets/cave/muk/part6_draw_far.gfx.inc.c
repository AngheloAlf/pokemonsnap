...
Gfx muk_part6_draw_far[] = {
    ...
    gsDPPipeSync(),
    gsSPModifyVertex(27, G_MWO_POINT_ST, 0x1533052F),
    gsSPModifyVertex(28, G_MWO_POINT_ST, 0x145D0571),
    gsSPModifyVertex(29, G_MWO_POINT_ST, 0x14950555),
    gsSPModifyVertex(30, G_MWO_POINT_ST, 0x163D0519),
    gsSPVertex(&muk_vtx[310], 3, 0),
    gsSP2Triangles(29, 28, 0, 0, 0, 2, 29, 0),
    gsSP2Triangles(2, 30, 29, 0, 1, 0, 28, 0),
    gsSP2Triangles(27, 30, 2, 0, 27, 1, 28, 0),
    gsSP1Triangle(2, 1, 27, 0),
    gsSPEndDisplayList(),
};
