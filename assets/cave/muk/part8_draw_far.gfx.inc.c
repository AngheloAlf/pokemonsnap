...
Gfx muk_part8_draw_far[] = {
    ...
    gsDPPipeSync(),
    gsSPModifyVertex(28, G_MWO_POINT_ST, 0x1454067E),
    gsSPModifyVertex(29, G_MWO_POINT_ST, 0x14DA05F9),
    gsSPModifyVertex(30, G_MWO_POINT_ST, 0x15AE067C),
    gsSPVertex(&muk_vtx[316], 6, 0),
    gsSP2Triangles(30, 28, 5, 0, 5, 28, 1, 0),
    gsSP2Triangles(28, 29, 1, 0, 5, 4, 30, 0),
    gsSP2Triangles(4, 5, 1, 0, 29, 30, 3, 0),
    gsSP2Triangles(2, 3, 4, 0, 2, 29, 3, 0),
    gsSP2Triangles(1, 2, 4, 0, 4, 3, 30, 0),
    gsSPEndDisplayList(),
};
