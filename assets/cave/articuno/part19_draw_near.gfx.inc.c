...
Gfx articuno_part19_draw_near[] = {
    ...
    gsDPPipeSync(),
    gsSPModifyVertex(0, G_MWO_POINT_ST, 0xFFF9037A),
    gsSPModifyVertex(1, G_MWO_POINT_ST, 0x03E9038C),
    gsSPModifyVertex(2, G_MWO_POINT_ST, 0x03E90385),
    gsSPModifyVertex(3, G_MWO_POINT_ST, 0x0003037A),
    gsSPVertex(&articuno_vtx[348], 1, 4),
