...
Gfx doduo_part12_draw_near[] = {
    ...
    gsDPPipeSync(),
    gsSPVertex(&doduo_vtx[196], 3, 0),
    gsSPVertex(&doduo_vtx[130], 1, 3),
    gsSPVertex(&doduo_vtx[199], 2, 4),
    gsSP2Triangles(1, 5, 2, 0, 4, 0, 2, 0),
    gsSP2Triangles(2, 5, 4, 0, 1, 0, 3, 0),
    gsSP2Triangles(3, 5, 1, 0, 0, 4, 3, 0),
    gsSPEndDisplayList(),
};
