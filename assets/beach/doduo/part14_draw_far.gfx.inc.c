...
Gfx doduo_part14_draw_far[] = {
    ...
    gsDPPipeSync(),
    gsSPVertex(&doduo_vtx[396], 20, 0),
    gsSP2Triangles(19, 18, 17, 0, 17, 18, 16, 0),
    gsSP2Triangles(16, 15, 17, 0, 17, 15, 19, 0),
    gsSP2Triangles(14, 13, 12, 0, 11, 12, 13, 0),
    gsSP2Triangles(12, 10, 14, 0, 11, 10, 12, 0),
    gsSP2Triangles(9, 8, 7, 0, 6, 8, 9, 0),
    gsSP2Triangles(7, 5, 9, 0, 9, 5, 6, 0),
