...
Gfx eevee_part1_draw_far[] = {
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_LIGHTING),
    gsSPVertex(&eevee_vtx[648], 8, 0),
    ...
    gsDPPipeSync(),
    gsSPVertex(&eevee_vtx[360], 14, 0),
    gsSP2Triangles(13, 12, 11, 0, 12, 13, 10, 0),
    gsSP2Triangles(10, 9, 12, 0, 9, 10, 8, 0),
    gsSP2Triangles(7, 6, 5, 0, 4, 6, 7, 0),
    gsSP2Triangles(3, 7, 5, 0, 7, 2, 4, 0),
    gsSP2Triangles(7, 3, 1, 0, 4, 2, 0, 0),
    gsSP2Triangles(1, 2, 7, 0, 0, 2, 1, 0),
    gsSPEndDisplayList(),
};
