...
Gfx eevee_part7_draw_near[] = {
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_LIGHTING),
    gsSPVertex(&eevee_vtx[600], 8, 0),
    ...
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 511, 1024),
    gsDPPipeSync(),
    gsSPVertex(&eevee_vtx[225], 8, 0),
    gsSP2Triangles(7, 6, 5, 0, 7, 4, 6, 0),
    gsSP2Triangles(5, 6, 3, 0, 3, 6, 4, 0),
    gsSP2Triangles(4, 2, 3, 0, 1, 3, 2, 0),
