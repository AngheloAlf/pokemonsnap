...
Gfx eevee_part8_draw_near[] = {
    gsDPPipeSync(),
    gsSPClearGeometryMode(G_LIGHTING),
    gsSPVertex(&eevee_vtx[608], 8, 0),
    ...
    gsDPPipeSync(),
    gsSPVertex(&eevee_vtx[233], 6, 0),
    gsSP2Triangles(5, 4, 3, 0, 2, 4, 5, 0),
    gsSP2Triangles(3, 1, 5, 0, 5, 0, 2, 0),
    gsDPPipeSync(),
    ...
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 511, 1024),
    gsDPPipeSync(),
    gsSPVertex(&eevee_vtx[239], 8, 0),
    gsSP2Triangles(7, 6, 5, 0, 4, 5, 6, 0),
    gsSP2Triangles(3, 7, 5, 0, 5, 2, 3, 0),
    gsSP2Triangles(5, 4, 1, 0, 3, 2, 0, 0),
    gsSP2Triangles(2, 1, 0, 0, 1, 2, 5, 0),
    gsSPEndDisplayList(),
};
