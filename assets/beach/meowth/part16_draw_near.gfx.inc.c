...
Gfx meowth_part16_draw_near[] = {
    ...
    gsDPPipeSync(),
    gsSPVertex(&meowth_vtx[351], 10, 0),
    gsSP2Triangles(9, 8, 7, 0, 7, 6, 9, 0),
    gsSP2Triangles(5, 7, 8, 0, 5, 6, 7, 0),
    gsSP2Triangles(8, 9, 4, 0, 8, 3, 5, 0),
    gsSP2Triangles(9, 6, 2, 0, 5, 2, 6, 0),
    gsSP2Triangles(2, 4, 9, 0, 1, 5, 3, 0),
    gsSP2Triangles(4, 0, 3, 0, 2, 5, 1, 0),
    gsSP2Triangles(3, 0, 1, 0, 2, 0, 4, 0),
    gsSP2Triangles(1, 0, 2, 0, 4, 3, 8, 0),
    gsSPEndDisplayList(),
};
