...
Gfx meowth_part0_draw_far[] = {
    ...
    gsDPPipeSync(),
    gsSPVertex(&meowth_vtx[387], 13, 0),
    gsSP2Triangles(3, 0, 12, 0, 11, 4, 3, 0),
    gsSP2Triangles(4, 11, 10, 0, 10, 9, 4, 0),
    gsSP2Triangles(8, 2, 1, 0, 2, 8, 7, 0),
    gsSP2Triangles(7, 6, 2, 0, 5, 2, 6, 0),
