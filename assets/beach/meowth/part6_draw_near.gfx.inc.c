...
Gfx meowth_part6_draw_near[] = {
    ...
    gsDPPipeSync(),
    gsSPVertex(&meowth_vtx[98], 11, 0),
    gsSP2Triangles(10, 9, 8, 0, 7, 8, 9, 0),
    gsSP2Triangles(6, 10, 8, 0, 9, 5, 7, 0),
    gsSP2Triangles(6, 8, 7, 0, 4, 5, 9, 0),
    gsSP2Triangles(9, 3, 4, 0, 9, 2, 3, 0),
    gsSP2Triangles(3, 2, 6, 0, 5, 1, 7, 0),
    gsSP2Triangles(4, 3, 6, 0, 7, 0, 6, 0),
    gsSP2Triangles(4, 1, 5, 0, 7, 1, 0, 0),
    gsSP2Triangles(0, 1, 4, 0, 6, 0, 4, 0),
    gsSPEndDisplayList(),
};
