...
Gfx meowth_part5_draw_near[] = {
    ...
    gsDPPipeSync(),
    gsSPVertex(&meowth_vtx[86], 12, 0),
    gsSP2Triangles(11, 10, 9, 0, 8, 10, 11, 0),
    gsSP2Triangles(11, 7, 8, 0, 6, 7, 11, 0),
    gsSP2Triangles(6, 11, 5, 0, 6, 5, 4, 0),
    gsSP2Triangles(8, 7, 3, 0, 3, 2, 8, 0),
    gsSP2Triangles(2, 3, 1, 0, 7, 6, 4, 0),
