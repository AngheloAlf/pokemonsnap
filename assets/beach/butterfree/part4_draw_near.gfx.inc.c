...
Gfx butterfree_part4_draw_near[] = {
    gsDPPipeSync(),
    ...
    gsDPPipeSync(),
    gsSPVertex(&butterfree_vtx[167], 17, 0),
    gsSP2Triangles(16, 15, 14, 0, 15, 13, 14, 0),
    gsSP2Triangles(12, 13, 15, 0, 11, 12, 15, 0),
    gsSP2Triangles(12, 11, 16, 0, 14, 12, 16, 0),
    gsSP2Triangles(10, 9, 8, 0, 9, 10, 7, 0),
    gsSP2Triangles(6, 9, 7, 0, 5, 8, 6, 0),
    gsSP2Triangles(5, 10, 8, 0, 7, 5, 6, 0),
    gsSP2Triangles(4, 3, 2, 0, 4, 1, 3, 0),
    gsSP2Triangles(4, 2, 1, 0, 0, 1, 2, 0),
