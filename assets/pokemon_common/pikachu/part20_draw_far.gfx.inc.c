...
Gfx pikachu_part20_draw_far[] = {
    ...
    gsSPVertex(&pikachu_vtx[368], 5, 0),
    gsSPVertex(&pikachu_vtx[374], 3, 5),
    gsSPVertex(&pikachu_vtx[556], 6, 8),
    gsSP2Triangles(13, 12, 11, 0, 10, 9, 11, 0),
