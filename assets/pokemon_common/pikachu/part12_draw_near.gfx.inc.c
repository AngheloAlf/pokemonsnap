...
Gfx pikachu_part12_draw_near[] = {
    ...
    gsSPModifyVertex(1, G_MWO_POINT_ST, 0x00DDFC54),
    gsSPModifyVertex(2, G_MWO_POINT_ST, 0x00B0FB45),
    gsSPModifyVertex(3, G_MWO_POINT_ST, 0x00B3FDF0),
    gsSPVertex(&pikachu_vtx[248], 5, 4),
    gsSP2Triangles(0, 1, 8, 0, 8, 7, 0, 0),
    gsSP2Triangles(3, 0, 7, 0, 1, 2, 6, 0),
    gsSP2Triangles(8, 5, 7, 0, 5, 8, 6, 0),
    gsSP2Triangles(7, 4, 3, 0, 2, 4, 6, 0),
    gsSP2Triangles(4, 7, 5, 0, 5, 6, 4, 0),
    gsSP2Triangles(6, 8, 1, 0, 4, 2, 3, 0),
    gsSPEndDisplayList(),
};
