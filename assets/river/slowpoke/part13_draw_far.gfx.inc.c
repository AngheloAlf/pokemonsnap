...
Gfx slowpoke_part13_draw_far[] = {
    ...
    gsDPPipeSync(),
    gsSPModifyVertex(28, G_MWO_POINT_ST, 0x04E10004),
    gsSPModifyVertex(29, G_MWO_POINT_ST, 0x04F00331),
    gsSPModifyVertex(30, G_MWO_POINT_ST, 0x05000314),
    gsSPVertex(&slowpoke_vtx[365], 1, 0),
