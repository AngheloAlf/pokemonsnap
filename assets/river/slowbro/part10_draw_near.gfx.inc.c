...
Gfx slowbro_part10_draw_near[] = {
    ...
    gsDPPipeSync(),
    gsSPModifyVertex(0, G_MWO_POINT_ST, 0xFFFC03F9),
    gsSPModifyVertex(2, G_MWO_POINT_ST, 0x040A0402),
    gsSPVertex(&slowbro_vtx[484], 2, 3),
    gsSP2Triangles(2, 0, 4, 0, 4, 3, 2, 0),
    gsDPPipeSync(),
    ...
    gsDPPipeSync(),
    gsSPModifyVertex(0, G_MWO_POINT_ST, 0x003400BF),
    gsSPModifyVertex(1, G_MWO_POINT_ST, 0x0312029E),
    gsSPModifyVertex(2, G_MWO_POINT_ST, 0x07B203AD),
    gsSPVertex(&slowbro_vtx[486], 2, 3),
    gsSP2Triangles(4, 1, 2, 0, 4, 3, 1, 0),
