...
Gfx slowbro_part7_draw_near[] = {
    ...
    gsSPVertex(&slowbro_vtx[231], 9, 0),
    ...
    gsSPVertex(&slowbro_vtx[240], 21, 0),
    gsSP2Triangles(20, 28, 27, 0, 19, 27, 30, 0),
    gsSP2Triangles(19, 18, 27, 0, 28, 20, 17, 0),
    gsSP2Triangles(17, 29, 28, 0, 30, 29, 16, 0),
    gsSP2Triangles(16, 15, 30, 0, 14, 13, 12, 0),
