...
Gfx zapdos_part6_draw_near[] = {
    ...
    gsSPVertex(&zapdos_vtx[104], 4, 4),
    gsSPVertex(&zapdos_vtx[108], 4, 27),
    gsSP2Triangles(29, 7, 28, 0, 27, 7, 29, 0),
    gsSP2Triangles(28, 6, 30, 0, 7, 5, 28, 0),
    gsSP2Triangles(30, 6, 27, 0, 28, 5, 6, 0),
    gsSP2Triangles(27, 4, 7, 0, 27, 6, 4, 0),
