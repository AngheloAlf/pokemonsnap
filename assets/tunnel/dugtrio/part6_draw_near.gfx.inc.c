...
Gfx dugtrio_part6_draw_near[] = {
    ...
    gsDPPipeSync(),
    gsSPVertex(&dugtrio_vtx[155], 12, 0),
    gsSP2Triangles(1, 0, 11, 0, 11, 10, 1, 0),
    gsSP2Triangles(1, 10, 9, 0, 9, 3, 1, 0),
    gsSP2Triangles(11, 0, 2, 0, 8, 11, 2, 0),
    gsSP2Triangles(3, 9, 7, 0, 2, 6, 8, 0),
    gsSP2Triangles(7, 4, 3, 0, 7, 6, 5, 0),
    gsSP2Triangles(5, 4, 7, 0, 2, 5, 6, 0),
    gsSPEndDisplayList(),
};
