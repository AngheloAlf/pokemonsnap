...
Gfx electrode_part5_draw_near[] = {
    ...
    gsDPSetEnvColor(0xFF, 0xFE, 0x00, 0xFF),
    ...
    gsSPVertex(&electrode_vtx[152], 1, 0),
    gsSPVertex(&electrode_vtx[154], 1, 1),
    gsSPVertex(&electrode_vtx[156], 1, 2),
