...
Gfx electabuzz_part3_draw_far[] = {
    ...
    gsDPPipeSync(),
    gsSPVertex(&electabuzz_vtx[309], 4, 0),
    ...
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 511, 1024),
    gsDPPipeSync(),
    gsSPVertex(&electabuzz_vtx[313], 4, 0),
    ...
    gsDPPipeSync(),
    gsSPVertex(&electabuzz_vtx[317], 5, 0),
    ...
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 1023, 512),
    gsDPPipeSync(),
    gsSPVertex(&electabuzz_vtx[322], 6, 0),
    gsSP2Triangles(5, 4, 3, 0, 3, 2, 5, 0),
    gsSP2Triangles(2, 1, 4, 0, 4, 0, 3, 0),
    gsSP2Triangles(1, 0, 4, 0, 3, 1, 2, 0),
    gsSPEndDisplayList(),
};
