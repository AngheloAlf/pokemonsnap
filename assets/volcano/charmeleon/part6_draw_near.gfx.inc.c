...
Gfx charmeleon_part6_draw_near[] = {
    gsDPPipeSync(),
    ...
    gsDPPipeSync(),
    gsSPVertex(&charmeleon_vtx[92], 5, 0),
    ...
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 63, 2048),
    gsDPPipeSync(),
    gsSPVertex(&charmeleon_vtx[97], 12, 0),
    ...
    gsSPVertex(&charmeleon_vtx[109], 6, 0),
    gsSP2Triangles(30, 29, 5, 0, 29, 4, 5, 0),
    gsSP2Triangles(5, 4, 3, 0, 3, 2, 5, 0),
    gsSP2Triangles(27, 3, 4, 0, 5, 1, 30, 0),
    gsSP2Triangles(2, 3, 27, 0, 2, 27, 28, 0),
    gsSP2Triangles(1, 0, 28, 0, 28, 30, 1, 0),
    gsSP2Triangles(4, 29, 27, 0, 28, 0, 2, 0),
    gsSPEndDisplayList(),
};
