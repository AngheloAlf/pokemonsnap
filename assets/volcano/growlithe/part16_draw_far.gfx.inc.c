...
Gfx growlithe_part16_draw_far[] = {
    ...
    gsSPVertex(&growlithe_vtx[493], 4, 27),
    gsSP2Triangles(2, 28, 27, 0, 1, 28, 2, 0),
    gsSP2Triangles(1, 30, 28, 0, 0, 29, 30, 0),
    ...
    gsSPVertex(&growlithe_vtx[497], 2, 3),
