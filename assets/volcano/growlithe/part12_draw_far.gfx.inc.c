...
Gfx growlithe_part12_draw_far[] = {
    ...
    gsDPPipeSync(),
    gsSPVertex(&growlithe_vtx[464], 2, 0),
    gsSPVertex(&growlithe_vtx[256], 1, 2),
    gsSPVertex(&growlithe_vtx[466], 4, 3),
    gsSP2Triangles(2, 6, 3, 0, 5, 3, 6, 0),
    gsSP2Triangles(6, 2, 1, 0, 5, 6, 1, 0),
    gsSP2Triangles(5, 4, 3, 0, 4, 0, 3, 0),
