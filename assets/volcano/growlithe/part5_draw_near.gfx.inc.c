...
Gfx growlithe_part5_draw_near[] = {
    ...
    gsDPPipeSync(),
    gsSPVertex(&growlithe_vtx[192], 8, 0),
    gsSP2Triangles(7, 6, 5, 0, 6, 4, 5, 0),
    gsSP2Triangles(4, 3, 5, 0, 6, 7, 2, 0),
    gsSP2Triangles(3, 4, 1, 0, 0, 4, 6, 0),
    gsSP2Triangles(0, 1, 4, 0, 6, 2, 0, 0),
    gsSPEndDisplayList(),
};
