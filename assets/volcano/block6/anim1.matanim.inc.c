#undef __ANIMFILE
#define __ANIMFILE volcano_block6_uvAnim

#include <anim_script.h>

extern AnimCmd* volcano_block6_uvAnim_root[];

AnimCmd* volcano_block6_uvAnim[] = {
    (AnimCmd*)&volcano_block6_uvAnim_root,
};

asBegin_3(volcano_block6_uvAnim_root_0)
...
AnimCmd* volcano_block6_uvAnim_root[] = {
    (AnimCmd*)&volcano_block6_uvAnim_root_0,
};
