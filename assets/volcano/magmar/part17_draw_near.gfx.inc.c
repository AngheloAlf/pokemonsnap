...
Gfx magmar_part17_draw_near[] = {
    ...
    gsSPVertex(&magmar_vtx[281], 3, 0),
    gsSP2Triangles(30, 28, 2, 0, 2, 28, 27, 0),
    gsSP2Triangles(29, 30, 1, 0, 0, 2, 27, 0),
    gsSP2Triangles(1, 2, 0, 0, 0, 27, 29, 0),
    gsSP2Triangles(29, 1, 0, 0, 2, 1, 30, 0),
    gsSPEndDisplayList(),
};
