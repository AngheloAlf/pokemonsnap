...
Gfx magmar_part14_draw_near[] = {
    ...
    gsSPVertex(&magmar_vtx[247], 3, 0),
    gsSP2Triangles(29, 27, 2, 0, 2, 27, 1, 0),
    gsSP2Triangles(27, 28, 1, 0, 2, 0, 29, 0),
    gsSP2Triangles(0, 30, 29, 0, 2, 1, 0, 0),
    gsSP2Triangles(1, 28, 30, 0, 30, 0, 1, 0),
    gsSPEndDisplayList(),
};
