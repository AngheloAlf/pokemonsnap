...
Gfx magmar_part2_draw_near[] = {
    ...
    gsDPPipeSync(),
    gsSPModifyVertex(28, G_MWO_POINT_ST, 0x086007B4),
    gsSPModifyVertex(29, G_MWO_POINT_ST, 0x00B106BA),
    gsSPModifyVertex(30, G_MWO_POINT_ST, 0x08B107C1),
    gsSPVertex(&magmar_vtx[14], 1, 0),
    gsSP2Triangles(0, 28, 30, 0, 30, 29, 0, 0),
