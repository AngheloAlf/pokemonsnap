...
Gfx magmar_part9_draw_near[] = {
    ...
    gsSP2Triangles(8, 5, 2, 0, 3, 2, 5, 0),
    gsSPModifyVertex(3, G_MWO_POINT_ST, 0x000203F6),
    gsSP2Triangles(3, 4, 0, 0, 4, 7, 0, 0),
    gsDPPipeSync(),
    gsDPSetTextureLUT(G_TT_NONE),
    gsDPSetCombineLERP(PRIMITIVE, 0, SHADE, 0, 0, 0, 0, PRIMITIVE, 0, 0, 0, COMBINED, 0, 0, 0, COMBINED),
    gsSPTexture(0, 0, 0, G_TX_RENDERTILE, G_OFF),
    gsSPVertex(&magmar_vtx[172], 3, 4),
    gsSP1Triangle(6, 5, 4, 0),
    gsSPEndDisplayList(),
};
