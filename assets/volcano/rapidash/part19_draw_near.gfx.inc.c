...
Gfx rapidash_part19_draw_near[] = {
    ...
    gsSPVertex(&rapidash_vtx[281], 10, 0),
    gsSP2Triangles(2, 3, 9, 0, 9, 8, 2, 0),
    gsSP2Triangles(1, 2, 8, 0, 0, 7, 6, 0),
    gsSP2Triangles(6, 5, 0, 0, 0, 4, 7, 0),
    gsDPPipeSync(),
    gsDPPipeSync(),
