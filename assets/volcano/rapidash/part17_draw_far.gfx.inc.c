...
Gfx rapidash_part17_draw_far[] = {
    ...
    gsSPVertex(&rapidash_vtx[503], 3, 3),
    ...
    gsSPVertex(&rapidash_vtx[506], 3, 0),
    gsSP2Triangles(29, 30, 2, 0, 30, 28, 1, 0),
    gsSP2Triangles(1, 28, 29, 0, 0, 29, 2, 0),
    gsSP2Triangles(1, 2, 30, 0, 29, 0, 1, 0),
    gsSPEndDisplayList(),
};
