...
Gfx rapidash_part10_draw_near[] = {
    ...
    gsSPVertex(&rapidash_vtx[186], 8, 3),
    ...
    gsSPVertex(&rapidash_vtx[194], 3, 28),
    gsSP2Triangles(2, 0, 30, 0, 0, 1, 29, 0),
    gsSP2Triangles(29, 1, 2, 0, 28, 2, 30, 0),
    gsSP2Triangles(2, 28, 29, 0, 29, 30, 0, 0),
    gsSPEndDisplayList(),
};
