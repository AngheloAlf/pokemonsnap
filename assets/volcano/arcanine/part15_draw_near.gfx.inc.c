...
Gfx arcanine_part15_draw_near[] = {
    ...
    gsSPVertex(&arcanine_vtx[293], 6, 4),
    gsSP2Triangles(9, 8, 3, 0, 3, 8, 7, 0),
    gsSP2Triangles(8, 6, 7, 0, 8, 5, 6, 0),
    gsSP2Triangles(4, 7, 6, 0, 5, 9, 4, 0),
    ...
    gsSPVertex(&arcanine_vtx[299], 5, 4),
    gsSP2Triangles(3, 1, 8, 0, 7, 8, 1, 0),
    gsSP2Triangles(8, 7, 6, 0, 6, 7, 5, 0),
    gsSP2Triangles(7, 4, 5, 0, 2, 7, 1, 0),
    gsSP2Triangles(0, 4, 7, 0, 7, 2, 0, 0),
    gsDPPipeSync(),
    ...
    gsSPVertex(&arcanine_vtx[304], 6, 4),
