...
Gfx arcanine_hd_part0_draw[] = {
    ...
    gsDPPipeSync(),
    gsSPVertex(&arcanine_hd_vtx[0], 6, 0),
    ...
    gsDPPipeSync(),
    gsSPVertex(&arcanine_hd_vtx[6], 6, 0),
    ...
    gsDPPipeSync(),
    gsSPVertex(&arcanine_hd_vtx[12], 8, 0),
    ...
    gsDPPipeSync(),
    gsSPVertex(&arcanine_hd_vtx[20], 7, 0),
