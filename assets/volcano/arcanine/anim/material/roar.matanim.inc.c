#undef __ANIMFILE
#define __ANIMFILE arcanine_matanim_roar

#include <anim_script.h>

extern AnimCmd* arcanine_matanim_roar_2[];

AnimCmd* arcanine_matanim_roar[] = {
    NULL,
    NULL,
    NULL,
    (AnimCmd*)&arcanine_matanim_roar_2,
    NULL,
    NULL,
    NULL,
    NULL,
...
asBegin_1(arcanine_matanim_roar_2_0)
    ...
    asWait(12);
asRestart(arcanine_matanim_roar_2_0);

AnimCmd* arcanine_matanim_roar_2[] = {
    (AnimCmd*)&arcanine_matanim_roar_2_0,
};
