...
Gfx charmander_part8_draw_near[] = {
    gsDPPipeSync(),
    ...
    gsDPPipeSync(),
    gsSPVertex(&charmander_vtx[184], 5, 4),
    ...
    gsSPVertex(&charmander_vtx[189], 10, 4),
    gsSP2Triangles(13, 2, 0, 0, 0, 12, 13, 0),
    gsSP2Triangles(2, 13, 11, 0, 10, 12, 0, 0),
    gsSP2Triangles(11, 9, 2, 0, 0, 1, 10, 0),
    gsSP2Triangles(1, 8, 10, 0, 1, 3, 8, 0),
    gsSP2Triangles(3, 9, 8, 0, 9, 3, 2, 0),
