...
Gfx dragonite_part14_draw_near[] = {
    gsDPPipeSync(),
    ...
    gsSPVertex(&dragonite_vtx[339], 2, 4),
    gsSPVertex(&dragonite_vtx[341], 4, 27),
    gsSP2Triangles(5, 0, 1, 0, 1, 3, 29, 0),
    gsSP2Triangles(2, 0, 4, 0, 0, 5, 4, 0),
    gsSP2Triangles(1, 29, 27, 0, 27, 5, 1, 0),
    gsSP2Triangles(30, 29, 3, 0, 2, 28, 3, 0),
    gsSP2Triangles(28, 2, 4, 0, 4, 5, 27, 0),
    gsSP2Triangles(28, 30, 3, 0, 27, 28, 4, 0),
    gsSPEndDisplayList(),
};
