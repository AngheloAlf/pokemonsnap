...
Gfx sandslash_part14_draw_far[] = {
    ...
    gsDPPipeSync(),
    gsSPModifyVertex(28, G_MWO_POINT_ST, 0x054900D3),
    gsSPModifyVertex(29, G_MWO_POINT_ST, 0x054900D3),
    gsSPModifyVertex(30, G_MWO_POINT_ST, 0x051404D3),
    gsSPVertex(&sandslash_vtx[440], 1, 0),
