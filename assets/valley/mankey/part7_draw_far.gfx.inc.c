...
Gfx mankey_part7_draw_far[] = {
    ...
    gsSPVertex(&mankey_vtx[374], 4, 3),
    gsSPVertex(&mankey_vtx[378], 3, 28),
    gsSP1Triangle(29, 0, 1, 0),
    ...
    gsSPModifyVertex(1, G_MWO_POINT_ST, 0x001B00F4),
    gsSP1Triangle(1, 5, 29, 0),
    gsSPModifyVertex(1, G_MWO_POINT_ST, 0x01D501AE),
    gsSPModifyVertex(2, G_MWO_POINT_ST, 0x01C801B6),
    gsSP2Triangles(30, 28, 1, 0, 4, 3, 2, 0),
    gsSPEndDisplayList(),
};
