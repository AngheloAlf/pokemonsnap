...
Gfx geodude_part7_draw_far[] = {
    ...
    gsDPPipeSync(),
    gsSPModifyVertex(0, G_MWO_POINT_ST, 0x03FF0067),
    gsSPModifyVertex(1, G_MWO_POINT_ST, 0x00750000),
    gsSPModifyVertex(2, G_MWO_POINT_ST, 0x02490023),
    gsSPVertex(&geodude_vtx[213], 1, 3),
    gsSPVertex(&geodude_vtx[410], 1, 26),
    gsSPVertex(&geodude_vtx[216], 2, 27),
    gsSPVertex(&geodude_vtx[411], 1, 29),
    gsSPVertex(&geodude_vtx[219], 1, 30),
    gsSP2Triangles(0, 2, 30, 0, 2, 1, 27, 0),
    gsSP2Triangles(26, 1, 0, 0, 28, 30, 2, 0),
    gsSP2Triangles(0, 29, 26, 0, 3, 27, 1, 0),
    gsSPEndDisplayList(),
};
