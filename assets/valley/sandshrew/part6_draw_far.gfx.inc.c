...
Gfx sandshrew_part6_draw_far[] = {
    ...
    gsDPPipeSync(),
    gsSPVertex(&sandshrew_vtx[334], 9, 0),
    gsSP2Triangles(8, 1, 2, 0, 7, 2, 0, 0),
    gsSP2Triangles(7, 0, 6, 0, 6, 0, 5, 0),
    gsSP2Triangles(4, 8, 2, 0, 8, 3, 6, 0),
    gsSP2Triangles(7, 4, 2, 0, 4, 3, 8, 0),
