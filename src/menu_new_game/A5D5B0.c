...
// BSS
extern s32 D_80118110_A934C0;
extern s32 D_80118114_A934C4;
...
void func_800E25C0_A5D970(void) {
    ...
    func_8036A8E4_83E094(D_80118110_A934C0);
    func_8036B9EC_83F19C(D_80118110_A934C0, 0, 0);
    func_8036C898_840048(D_80118110_A934C0, D_80168130);
    if (D_80168143 < 14) {
        D_80168143 += 2;
    }
    if (D_80168143 == 14) {
...
void func_800E2A84_A5DE34(char* arg0) {
    ...
    if (D_80168143 >= 14 || menu_new_game_CursorY>= 19) {
        ...
        func_8036D1A4_840954(D_80118114_A934C4, 1);
        return;
    }
    ...
    if (func_800E2A24_A5DDD4(arg0) != 0) {
        ...
        D_8016814C = 0;
        func_8036D1A4_840954(D_80118114_A934C4, 0);
    }
    func_8036A8E4_83E094(D_80118114_A934C4);
    func_8036B9EC_83F19C(D_80118114_A934C4, 0, 0);
    func_8036CBA0_840350(D_80118114_A934C4, sp1A, 0x40);
    func_8036C898_840048(D_80118114_A934C4, arg0);
}
...
void func_800E2C38_A5DFE8(GObj* arg0) {
    ...
    while (TRUE) {
        ...
        if (var_s0 > 160) {
            func_8036D248_8409F8(D_80118114_A934C4, 255, 255, 255, 255);
        } else {
            func_8036D248_8409F8(D_80118114_A934C4, 255, 255, 255, 0);
        }
        ohWait(1);
    }
}
